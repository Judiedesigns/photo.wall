...
A local photo board for hanging favorite photos and notes as scattered polaroids.
...
This version has no Firebase, no backend, no account, no passphrase, and no real-time syncing. Photos and notes are private to the browser and device where they were added.
